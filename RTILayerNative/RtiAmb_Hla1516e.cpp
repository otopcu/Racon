...
// Join Federation
void RtiAmb_Hla1516e::joinFederation(String ^fedexec, String ^fdName) {
  ...
  while ((numTries++ < 20) && !joined) {
    try {
      ...
      String^ msg = "Federate (" + gcnew String(fd) + ") joined to the federation execution (" + gcnew String(fedx) + "). " + handle;
...
#pragma region exceptions
    ...
    String^ msg = "MSG-(NotConnected - resignFederation):" + Environment::NewLine + " Reason: " + gcnew String(e.what().c_str()) + Environment::NewLine;
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
  }
  catch (RTIinternalError& e) {
...
#pragma region exceptions
    ...
    String^ msg = "MSG-(NotConnected - destroyFederation):" + Environment::NewLine + " Reason: " + gcnew String(e.what().c_str()) + Environment::NewLine;
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
  }
  catch (RTIinternalError& e) {
...
#pragma region exceptions
    ...
    String^ msg = "MSG-(NotConnected - publishObjectClass):" + Environment::NewLine + " Reason: " + gcnew String(e.what().c_str()) + Environment::NewLine;
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
  }
  catch (RTIinternalError& e) {
...
#pragma region exceptions
    ...
    String^ msg = "MSG-(NotConnected - publishInteractionClass):" + Environment::NewLine + " Reason: " + gcnew String(e.what().c_str()) + Environment::NewLine;
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
  }
  catch (RTIinternalError& e) {
...
#pragma region exceptions
    ...
    String^ msg = "MSG-(NotConnected - subscribeObjectClass):" + Environment::NewLine + " Reason: " + gcnew String(e.what().c_str()) + Environment::NewLine;
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
    return false;
  }
  catch (RTIinternalError& e) {
...
#pragma region exceptions
    ...
    String^ msg = "MSG-(NotConnected - subscribeInteractionClass):" + Environment::NewLine + " Reason: " + gcnew String(e.what().c_str()) + Environment::NewLine;
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
  }
  catch (RTIinternalError& e) {
...
#pragma region exceptions
    ...
    String^ msg = "MSG-(NotConnected - updateAttributeValues):" + Environment::NewLine + " Reason: " + gcnew String(e.what().c_str()) + Environment::NewLine;
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
  }
  catch (RTIinternalError& e) {
...
#pragma region exceptions
    ...
    String^ msg = "MSG-(NotConnected - sendInteraction):" + Environment::NewLine + " Reason: " + gcnew String(e.what().c_str()) + Environment::NewLine;
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
  }
  catch (RTIinternalError& e) {
...
#pragma region exceptions
    ...
    String^ msg = "MSG-(NotConnected - deleteObjectInstance):" + Environment::NewLine + " Reason: " + gcnew String(e.what().c_str()) + Environment::NewLine;
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
  }
  catch (RTIinternalError& e) {
...
#pragma region exceptions
    ...
    String^ msg = "MSG-(NotConnected - requestAttributeValueUpdate):" + Environment::NewLine + " Reason: " + gcnew String(e.what().c_str()) + Environment::NewLine;
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
  }
  catch (RTIinternalError& e) {
...
#pragma region exceptions
    ...
    String^ msg = "MSG-(NotConnected - requestAttributeValueUpdate2):" + Environment::NewLine + " Reason: " + gcnew String(e.what().c_str()) + Environment::NewLine;
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
  }
  catch (RTIinternalError& e) {
...
bool RtiAmb_Hla1516e::enableObjectClassRelevanceAdvisorySwitch() {
  try {
...
#pragma region exceptions
    ...
    String^ msg = "MSG-(NotConnected-enableClassRelevanceAdvisorySwitch-RtiAmb_Hla1516e):" + Environment::NewLine + " Reason: " + gcnew String(e.what().c_str()) + Environment::NewLine;
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
  }
  catch (RTIinternalError& e) {
...
bool RtiAmb_Hla1516e::disableObjectClassRelevanceAdvisorySwitch() {
  try {
...
#pragma region exceptions
    ...
    String^ msg = "MSG-(NotConnected - enableAttributeRelevanceAdvisorySwitch):" + Environment::NewLine + " Reason: " + gcnew String(e.what().c_str()) + Environment::NewLine;
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
  }
  catch (RTIinternalError& e) {
...
bool RtiAmb_Hla1516e::disableAttributeRelevanceAdvisorySwitch() {
  try {
...
#pragma region exceptions
    ...
    String^ msg = "MSG-(NotConnected - disableAttributeRelevanceAdvisorySwitch):" + Environment::NewLine + " Reason: " + gcnew String(e.what().c_str()) + Environment::NewLine;
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
  }
  catch (RTIinternalError& e) {
...
#pragma region exceptions
    ...
    String^ msg = "MSG-(NotConnected - enableAttributeScopeAdvisorySwitch):" + Environment::NewLine + " Reason: " + gcnew String(e.what().c_str()) + Environment::NewLine;
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
  }
  catch (RTIinternalError& e) {
...
bool RtiAmb_Hla1516e::disableAttributeScopeAdvisorySwitch() {
  try {
...
#pragma region exceptions
    ...
    String^ msg = "MSG-(NotConnected - disableAttributeScopeAdvisorySwitch):" + Environment::NewLine + " Reason: " + gcnew String(e.what().c_str()) + Environment::NewLine;
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
  }
  catch (RTIinternalError& e) {
...
#pragma region exceptions
    ...
    String^ msg = "MSG-(NotConnected - enableInteractionRelevanceAdvisorySwitch):" + Environment::NewLine + " Reason: " + gcnew String(e.what().c_str()) + Environment::NewLine;
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
  }
  catch (RTIinternalError& e) {
...
bool RtiAmb_Hla1516e::disableInteractionRelevanceAdvisorySwitch() {
  try {
...
#pragma region exceptions
    ...
    String^ msg = "MSG-(NotConnected - disableInteractionRelevanceAdvisorySwitch):" + Environment::NewLine + " Reason: " + gcnew String(e.what().c_str()) + Environment::NewLine;
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
  }
  catch (RTIinternalError& e) {
