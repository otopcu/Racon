...
#pragma region exceptions
      ...
      String^ msg = "RtiAmb_Hla1516e-(InconsistentFDD - joinFederation2). Federation Execution does not exist. Please, restart the federate. Reason: " + gcnew String(e.what().c_str());
      this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
    }
    catch (ErrorReadingFDD& e) {
      String^ msg = "RtiAmb_Hla1516e-(ErrorReadingFED - joinFederation2). Invalid FOM Module. Reason:  " + gcnew String(e.what().c_str());
      this->OnRTIEventOccured(gcnew RaconEventArgs(msg, LogLevel::WARN));
    }
    catch (InconsistentFDD& e) {
      String^ msg = "RtiAmb_Hla1516e-(InconsistentFDD - joinFederation2). Inconsistent FOM Module. Reason: " + gcnew String(e.what().c_str());
      this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
    }
    catch (CouldNotOpenFDD& e) {
      String^ msg = "RtiAmb_Hla1516e-(CouldNotOpenFDD - joinFederation2). Federate cannot open the FED file. Either the file does not exist or there exists an error in the file name or path provided. Please, check that FED file exists and its path is correct. Reason: " + gcnew String(e.what().c_str());
      this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
    }
    catch (SaveInProgress& e) {
      ...
      String^ msg = "RtiAmb_Hla1516e-(FederateNotExecutionMember - joinFederation2): Federation execution name is " + federationExecutionName + ". Reason: " + gcnew String(e.what().c_str());
      this->OnRTIEventOccured(gcnew RaconEventArgs(msg, LogLevel::WARN));
    }
    catch (NotConnected& e) {
...
bool RtiAmb_Hla1516e::subscribeObjectClass(HlaObjectClass ^oc, List<HlaAttribute^>^ attributes, Boolean active)
{
  try {
    List<HlaAttribute^> ^tmpList = gcnew List<HlaAttribute^>();
...
#pragma region exceptions
    ...
    String^ msg = "RtiAmb_OpenRti_1516e-(Exception - registerObjectInstanceWithRegions). Reason: " + gcnew String(e->ToString());
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg, LogLevel::ERROR));
  }
#pragma endregion
};
...
#pragma region exceptions
    ...
    String^ msg = "RtiAmb_OpenRti_1516e-(Exception - associateRegionsForUpdates). Reason: " + gcnew String(e->ToString());
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg, LogLevel::ERROR));
  }
#pragma endregion
};
...
#pragma region exceptions
    ...
    String^ msg = "RtiAmb_OpenRti_1516e-(Exception - unassociateRegionsForUpdates). Reason: " + gcnew String(e->ToString());
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg, LogLevel::ERROR));
  }
#pragma endregion
};
...
bool RtiAmb_Hla1516e::subscribeObjectClassAttributesWithRegions(HlaObjectClass ^oc, RtiLayer::AttributeHandleSetRegionHandleSetPairVector ^list, bool indicator) {
  try {
    rti1516e::AttributeHandleSetRegionHandleSetPairVector _pairs;
    ...
    rti->subscribeObjectClassAttributesWithRegions(_handle, _pairs, indicator);
...
#pragma region exceptions
    ...
    String^ msg = "RtiAmb_OpenRti_1516e-(InvalidRangeBound - setRangeBounds): Reason: " + gcnew String(e.what().c_str());
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg, LogLevel::WARN));
  }
  catch (RegionDoesNotContainSpecifiedDimension& e) {
    String^ msg = "RtiAmb_OpenRti_1516e-(RegionDoesNotContainSpecifiedDimension - setRangeBounds): Reason: " + gcnew String(e.what().c_str());
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg, LogLevel::WARN));
  }
  catch (RegionNotCreatedByThisFederate& e) {
    String^ msg = "RtiAmb_OpenRti_1516e-(RegionNotCreatedByThisFederate - setRangeBounds): Reason: " + gcnew String(e.what().c_str());
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg, LogLevel::WARN));
  }
  catch (InvalidRegion& e) {
    String^ msg = "RtiAmb_OpenRti_1516e-(InvalidRegion - setRangeBounds): Reason: " + gcnew String(e.what().c_str());
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg, LogLevel::WARN));
  }
  catch (SaveInProgress& e) {
    String^ msg = "RtiAmb_OpenRti_1516e-(SaveInProgress - setRangeBounds): Reason: " + gcnew String(e.what().c_str());
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg, LogLevel::WARN));
  }
  catch (RestoreInProgress& e) {
    String^ msg = "RtiAmb_OpenRti_1516e-(RestoreInProgress - setRangeBounds): Reason: " + gcnew String(e.what().c_str());
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg, LogLevel::WARN));
  }
  catch (FederateNotExecutionMember& e) {
    String^ msg = "RtiAmb_OpenRti_1516e-(FederateNotExecutionMember - setRangeBounds): Reason: " + gcnew String(e.what().c_str());
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
  }
  catch (NotConnected& e) {
    String^ msg = "RtiAmb_OpenRti_1516e-(NotConnected - setRangeBounds): Reason: " + gcnew String(e.what().c_str());
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg));
  }
  catch (RTIinternalError& e) {
    String^ msg = "RtiAmb_OpenRti_1516e-(RTIinternalError - setRangeBounds). Reason: " + gcnew String(e.what().c_str());
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg, LogLevel::WARN));
  }
  catch (System::Exception^ e) {
    String^ msg = "RtiAmb_OpenRti_1516e-(Exception - setRangeBounds). Reason: " + gcnew String(e->ToString());
    this->OnRTIEventOccured(gcnew RaconEventArgs(msg, LogLevel::ERROR));
  }
#pragma endregion
};
